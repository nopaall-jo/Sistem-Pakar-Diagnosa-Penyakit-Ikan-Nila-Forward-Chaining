<?php
// Pastikan session sudah berjalan untuk menangkap notifikasi Toastr
...
<head>
    ...
    <style>
        /* Custom styling agar layout rapi dan footer selalu di bawah */
        body {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success shadow-sm">
    ...
    <i class="fas fa-fish me-2"></i>Sistem Pakar Ikan Nila
</a>
